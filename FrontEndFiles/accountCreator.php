...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($_POST["username"])){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                echo "Don't know how we got here :/, try again. DEBUG SELECT QUERY";
            }
        }
    ...
    if(empty(trim($_POST['password']))){
        $password_err = "Please dont leave password field blank.";     
    ...
    //Dont insert if fields are empty
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                echo "Not sure how we got here :/, try again. DEBUG INSERT QUERY";
            }
        }
         //cleanup
        mysqli_stmt_close($stmt);
